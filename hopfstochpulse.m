function [Xdet, Xsto, Fext] = hopfstochpulse(mu,fosc,xNoiseSTD,yNoiseSTD,tvec,Fextmax,pulsestart,pulseend)
%
...
%
% [Xdet Xsto] = hopfstochpulse(mu,fosc,xNoiseSTD,yNoiseSTD,tvec,Fextmax,pulsestart,pulseend)
%
